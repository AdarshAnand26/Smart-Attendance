...
def teacher_dashboard():
    ...
    with tab1:
        ...
        if st.button('Take Attendance', type=t1, use_container_width=True):
            st.session_state.current_teacher_tab = 'take_attendance'
            st.rerun()
    with tab2:
        t2 = "primary" if st.session_state.current_teacher_tab == 'manage_subjects' else "tertiary"
        if st.button('Manage Subjects', type=t2, use_container_width=True):
            st.session_state.current_teacher_tab = 'manage_subjects'
            st.rerun()
    with tab3:
        t3 = "primary" if st.session_state.current_teacher_tab == 'attendance_records' else "tertiary"
        if st.button('Attendance Records', type=t3, use_container_width=True):
...
def teacher_tab_take_attendance():
    ...
    st.markdown("""
        <h3 style="font-size:1.1rem; font-weight:700; color:#E2E8F0 !important; margin:0 0 1rem 0;">
            Take AI Attendance
        </h3>
    """, unsafe_allow_html=True)
    ...
    if st.session_state.attendance_images:
        st.markdown("""
            <p style="font-size:0.8rem; font-weight:600; color:#94A3B8 !important;
            text-transform:uppercase; letter-spacing:1px; margin:0 0 0.75rem 0;">
                Uploaded Photos
            </p>
        """, unsafe_allow_html=True)
    ...
    with c1:
        if st.button('Clear Photos', use_container_width=True,
                     type='tertiary', disabled=not has_photos):
            st.session_state.attendance_images = []
            st.rerun()

    with c2:
        if st.button('Run Face Analysis', use_container_width=True,
                     type='secondary', disabled=not has_photos):
    ...
    with c3:
        if st.button('Voice Attendance', type='primary', use_container_width=True):
...
def teacher_tab_manage_subjects():
    ...
    with col1:
        st.markdown("""
            ...
            color:#E2E8F0 !important; margin:0;">Manage Subjects</h3>
        """, unsafe_allow_html=True)
    with col2:
        ...
        st.markdown("""
            ...
            ">
                <p style="color: #94A3B8 !important; margin: 0; font-size: 0.9rem;">
                    No subjects yet. Click <b>+ Create Subject</b> to add one.
                </p>
            </div>
        """, unsafe_allow_html=True)
...
def teacher_tab_attendance_records():
    st.markdown("""
        <h3 style="font-size:1.1rem; font-weight:700;
        color:#E2E8F0 !important; margin:0 0 1rem 0;">Attendance Records</h3>
    """, unsafe_allow_html=True)
...
def teacher_screen_login():
    ...
    st.markdown("""
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            color:#0F172A !important; margin:0 0 6px 0;">Teacher Login</h2>
...
def teacher_screen_register():
    ...
    st.markdown("""
        <div style="text-align: center; margin-bottom: 2rem;">
            <h2 style="font-size:1.6rem; font-weight:700;
            color:#0F172A !important; margin:0 0 6px 0;">Create Teacher Account</h2>
            <p style="color:#94A3B8 !important; font-size:0.85rem; margin:0;">
